...
"""
Common templates test RHEL 8.2
"""
...
class TestCommonTemplatesRhel82:
    @pytest.mark.run("first")
    @pytest.mark.polarion("CNV-3743")
    def test_create_vm(
        self,
        skip_upstream,
        unprivileged_client,
