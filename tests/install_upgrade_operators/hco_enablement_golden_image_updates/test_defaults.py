...
@pytest.mark.usefixtures(
    "hyperconverged_spec_scope_session", "hyperconverged_status_scope_session"
)
...
def test_no_data_import_template_in_hco_spec(
    ...
    assert SSP_CR_COMMON_TEMPLATES_LIST_KEY_NAME not in json.dumps(
        hyperconverged_spec_scope_session
...
def test_data_import_template_defaults_hco_status(
    ...
    assert (
        SSP_CR_COMMON_TEMPLATES_LIST_KEY_NAME in hyperconverged_status_scope_session
