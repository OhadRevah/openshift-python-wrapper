...
KV_MOD_DEFAUTL_CA_DUR[KUBEVIRT_CR_CERT_CONFIG_SELF_SIGNED_KEY][
    HCO_CR_CERT_CONFIG_CA_KEY
][HCO_CR_CERT_CONFIG_DURATION_KEY] = CERTC_DEFAULT_48H
KV_MOD_DEFAUTL_CA_RB[KUBEVIRT_CR_CERT_CONFIG_SELF_SIGNED_KEY][
    HCO_CR_CERT_CONFIG_CA_KEY
][HCO_CR_CERT_CONFIG_RENEW_BEFORE_KEY] = CERTC_DEFAULT_24H
KV_MOD_DEFAUTL_SER_DUR[KUBEVIRT_CR_CERT_CONFIG_SELF_SIGNED_KEY][
    HCO_CR_CERT_CONFIG_SERVER_KEY
][HCO_CR_CERT_CONFIG_DURATION_KEY] = CERTC_DEFAULT_24H
KV_MOD_DEFAUTL_SER_RB[KUBEVIRT_CR_CERT_CONFIG_SELF_SIGNED_KEY][
    HCO_CR_CERT_CONFIG_SERVER_KEY
][HCO_CR_CERT_CONFIG_RENEW_BEFORE_KEY] = CERTC_DEFAULT_12H
...
HCO_MOD_DEFAUTL_CA_DUR[HCO_CR_CERT_CONFIG_CA_KEY][
    HCO_CR_CERT_CONFIG_DURATION_KEY
] = CERTC_DEFAULT_48H
HCO_MOD_DEFAUTL_CA_RB[HCO_CR_CERT_CONFIG_CA_KEY][
    HCO_CR_CERT_CONFIG_RENEW_BEFORE_KEY
] = CERTC_DEFAULT_24H
HCO_MOD_DEFAUTL_SER_DUR[HCO_CR_CERT_CONFIG_SERVER_KEY][
    HCO_CR_CERT_CONFIG_DURATION_KEY
] = CERTC_DEFAULT_24H
HCO_MOD_DEFAUTL_SER_RB[HCO_CR_CERT_CONFIG_SERVER_KEY][
    HCO_CR_CERT_CONFIG_RENEW_BEFORE_KEY
] = CERTC_DEFAULT_12H
