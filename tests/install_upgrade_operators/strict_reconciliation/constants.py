...
LM_PO_DEFAULT = {
    PARALLEL_OUTBOUND_MIGRATIONS_PER_NODE: LM_PARALLELOUTBOUNDMIGRATIONSPERNODE_DEFAULT,
}
...
EXPCT_LM_DEFAULTS = {
    PARALLEL_MIGRATIONS_PER_CLUSTER: LM_PARALLELMIGRATIONSPERCLUSTER_DEFAULT,
    PARALLEL_OUTBOUND_MIGRATIONS_PER_NODE: LM_PARALLELOUTBOUNDMIGRATIONSPERNODE_DEFAULT,
    COMPLETION_TIMEOUT_PER_GIB: LM_COMPLETIONTIMEOUTPERGIB_DEFAULT,
    PROGRESS_TIMEOUT: LM_PROGRESSTIMEOUT_DEFAULT,
}
EXPCT_LM_CUSTOM = {
    PARALLEL_MIGRATIONS_PER_CLUSTER: LM_PARALLELMIGRATIONSPERCLUSTER_CUSTOM,
    PARALLEL_OUTBOUND_MIGRATIONS_PER_NODE: LM_PARALLELOUTBOUNDMIGRATIONSPERNODE_CUSTOM,
    COMPLETION_TIMEOUT_PER_GIB: LM_COMPLETIONTIMEOUTPERGIB_CUSTOM,
    PROGRESS_TIMEOUT: LM_PROGRESSTIMEOUT_CUSTOM,
}
...
LM_CUST_DEFAULT_C[COMPLETION_TIMEOUT_PER_GIB] = LM_COMPLETIONTIMEOUTPERGIB_DEFAULT
LM_CUST_DEFAULT_PT[PROGRESS_TIMEOUT] = LM_PROGRESSTIMEOUT_DEFAULT
...
EXPCT_LM_CUSTOM_C[COMPLETION_TIMEOUT_PER_GIB] = LM_COMPLETIONTIMEOUTPERGIB_CUSTOM
EXPCT_LM_CUSTOM_PT[PROGRESS_TIMEOUT] = LM_PROGRESSTIMEOUT_CUSTOM
EXPCT_CERTC_CUSTOM = {
    "ca": {
...
HCO_CR_FIELDS = ["certConfig", LIVE_MIGRATION_CONFIG_KEY, "featureGates"]
