...
@pytest.fixture()
def node_maintenance_resources(
    admin_client, hco_namespace, nmo_removal_matrix__function__
):
    return [
        resource.name
        for resource in nmo_removal_matrix__function__.get(
...
def test_validate_nmo_removal(
    hco_namespace, nmo_removal_matrix__function__, node_maintenance_resources
):
